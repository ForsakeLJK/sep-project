...
interface ContentBudgetPMProps {
    btn_type: string | null;
    user_name: string | null;
}

const ContentBudgetPM: React.FC<ContentBudgetPMProps> = ({ btn_type, user_name }) => {
    ...
    const handleRequestSubmit = async () => {
        ...
        if (response.createSuccess) {
            setSnackbarMessage('Budget request submitted successfully!');
            setSnackbarSeverity('success');
            fetchRequests(); // Re-fetch to update the list
        } else {
            setSnackbarMessage('Failed to submit budget request.');
...
export default ContentBudgetPM;